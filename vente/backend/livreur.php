       ...
       <div class="row mt">
          <div class="col-md-12">
            <div class="content-panel">
              <h4><i class="fa fa-angle-right"></i> La liste des livreurs                          <a style="float: right; padding-right: 68px;" class="fa fa-user-plus" href="addLivreur.php"></a></h4> <hr><table class="table table-striped table-advance table-hover">
                
                
                <thead>
                  <tr>
                    <th> #</th>
                    <th class="hidden-phone"><i class="fa fa-bookmark"></i> Nom</th>
                    <th><i class="fa fa-question-circle"></i> Prénom</th>
                          ...
                          if(mysqli_num_rows($result) > 0){
                              while($row = mysqli_fetch_array($result)){
                                  echo "<tr>";
                                      ...
                                      echo "<td>";
                                      echo "<button class='btn btn-primary btn-xs'><i class='fa fa-pencil' onclick='window.location=\"editLivreur.php?id=".$row['id']."\"'></i></button>";
                                      echo " <button class='btn btn-danger btn-xs'><i class='fa fa-trash-o ' onclick='window.location=\"delLivreur.php?id=".$row['id']."\"'></i></button>";
                                      echo "</td>";
                                  echo "</tr>";
                              }
                              echo "</table>";
