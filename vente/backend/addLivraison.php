...
<body>
  <section id="container">
       ...
       <div class="row mt">
          <div class="col-md-12">
            <div class="content-panel">
              <h4><i class="fa fa-angle-right"></i> Ajout livraison    
    ...
    <p>
        ...
        <input type="text" class="form-control" name="livreur" id="livreur" required="true">
    </p>
    <p>
        <label for="delay">delai:</label>
        <input type="text" class="form-control" name="delay" id="delay" required="true">
    </p>
                  ...
                  <?php
                   /* Attempt MySQL server connection. Assuming you are running MySQL
                    ...
                    if($_REQUEST) {
                        ...
                        $sql = "INSERT INTO livraison (libelle, id_liv, delay) VALUES ('$libelle', '$livreur', '$delay')";
