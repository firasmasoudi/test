       ...
       <div class="row mt">
          <div class="col-md-12">
            <div class="content-panel">
              <h4><i class="fa fa-angle-right"></i> Edition du livreur <a style="float: right; padding-right: 68px;" class="fa fa-user-plus" href="addLivreur.php"></a></h4> <hr><table class="table table-striped table-advance table-hover">
                <?php
                      ...
                      $sql = "SELECT * FROM livreur where id =".$_GET['id'];
                      if($result = mysqli_query($link, $sql)){
                          if(mysqli_num_rows($result) > 0){
                              while($row = mysqli_fetch_array($result)){
?>
                                  <form action="editLivreur.php?id=<?php echo $row['id']; ?>" method="post">
    <p>
    ...
    <p>
        ...
        <input type="text" class="form-control" name="prenom" id="prenom" value="<?php echo $row['prenom']; ?>" required="true">
    </p>
    <p>
     ...
     <p>
        ...
        <input type="text" class="form-control" name="telephone" value="<?php echo $row['telephone']; ?>" id="telephone">
    </p>
    <input type="submit" class="btn btn-primary" value="Submit">
                       ...
                       if(!empty($_REQUEST['nom'])) {
                          ...
                          $sql = "UPDATE livreur SET nom = '$nom', prenom = '$prenom', telephone = '$telephone' ,email = '$email' where id= ".$_GET['id'];
